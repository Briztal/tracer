...
/*The timer lib includes a neutral timer if, so that timer drivers can prevent access to their functions;*/
...
/*
 * Most timer if function have their static inline shortcuts. To access a member x, use timer_x with appropriate
 * 	arguments;
 */
