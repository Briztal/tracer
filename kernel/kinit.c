...
void __krnl_init() {
	...
	static volatile bool reentrance;
	...
	if (reentrance) {
        ...
        __kernel_panic("kernel_init : attempted to initialise a second time;");
    ...
    /*Log.*/
    __printk("Entering kernel initialisation sequence;\n");
    ...
    __kernel_panic("kernel_init : execution not started;");
