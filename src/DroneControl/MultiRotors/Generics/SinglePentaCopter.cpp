/*
  SinglePentaCopter.cpp - Part of TRACER
...
SinglePentaCopter::SinglePentaCopter() : SolidMultiRotor(), MotorRegisterer(5) {}
...
SinglePentaCopter::~SinglePentaCopter() = default;
...
void SinglePentaCopter::registerMotor(uint8_t motor_index, float x, float y, float z, bool direction,
    ...
    if (isRegistered(motor_index)) {
        ...
        //Log;
        std_out("Error in SinglePentaCopter::setRegistered : the index is incorrect, or the motor has already been added.");
    ...
    MotorData *motor_data =
            new MotorData(x, y, z, 0, 0, direction, traction_coeff, torque_coeff, kV, voltage,max_signal, servo_index);
