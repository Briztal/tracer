#
# This file contains all configurable parameters when building for the mk64fx512
#

#------------------------------------------------- Flash configuration -------------------------------------------------

#8 bytes of the backdoor comparison key, most significant on the right, comma separated with no comma at the end
...
#Should the PLL stay enabled in stop mode ?
