...
private :
     ...
     *      (((v * v) / (2 * EEPROMMap::accelerations[trajectory_control] * EEPROMMap::feedrate[trajectory_control]));
     *
     *  the denominator is constant. This array wil contain the float value
     *      1.0 / (2.0 * EEPROMMap::accelerations[trajectory_control] * EEPROMMap::feedrate[trajectory_control]));
     *
     ...
     *      max_delta_speed = EEPROMMap::accelerations[trajectory_control] * EEPROMMap::feedrate[trajectory_control] * time;
     *
     *  the product of the two first terms is constant. This array wil contain the float value
     *      EEPROMMap::accelerations[trajectory_control] * EEPROMMap::feedrate[trajectory_control]
     *
     *      for each trajectory_control.
     */
     ...
     *      max_speed = EEPROMMap::speeds[trajectory_control] * EEPROMMap::feedrate[trajectory_control] * time;
     *
     *  the product is constant. This array wil contain the float value
     *      EEPROMMap::speeds[trajectory_control] * EEPROMMap::feedrate[trajectory_control]
     *
     *      for each trajectory_control.
     */
