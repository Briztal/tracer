...
static void
int_decode(void (*exec)(void *arg, const char *data, size_t size), void *arg, uint32_t integer, uint8_t base) {
...
void fdecode(void (*exec)(void *arg, const char *data, size_t size), void *arg, const char *str, const void **args,
			 size_t args_size) {
