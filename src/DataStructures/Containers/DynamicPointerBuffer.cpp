/*
  PointerVector.cpp - Part of TRACER
...
#ifndef TRACER_DYNAMICPOINTERBUFFER_CPP
#define TRACER_DYNAMICPOINTERBUFFER_CPP

#include "DynamicPointerBuffer.h"
...
template<typename T>
DynamicPointerBuffer<T>::DynamicPointerBuffer(const DynamicPointerBuffer &container) : DynamicPointerBuffer(
        container.maxSize) {
...
#endif //TRACER_DYNAMICPOINTERBUFFER_CPP