...
/*
 * exec_node_compute : The computation function of an execution node;
 *
...
bool exec_node_compute(concurrent_node_t *const exec_node) {
	...
	//If the computation is INCOMPLETE, the node status is incomplete, and data remains initialised;
