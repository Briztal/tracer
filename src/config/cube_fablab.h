...
AXIS_TREATMENT(0, '0', 170, 80, 300, 800, HIGH, 54, 55, 38, 3, HIGH, 2, HIGH);

AXIS_TREATMENT(1, '1', 170, 80, 300, 400, HIGH, 46, 48, 62, 18, HIGH, 19, HIGH);

AXIS_TREATMENT(2, '2', 150., 2540, 4, 5000, LOW, 60, 61, 56, 14, HIGH, 1, HIGH);
