 ...
 *
 * When the square root is modfied, it sets sub_movement_time_update_flag, so that delay_us (regulation_speed) will be modified aferwards.
 *
 * The delay_us is set according to  : delay_us = delay_numerator/sqrt(primary)
 *
 */
