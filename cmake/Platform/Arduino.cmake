...
#
# Creates the Arduino Coreb library for the specified board,
...
function(setup_arduino_programmer_args BOARD_ID PROGRAMMER TARGET_NAME PORT AVRDUDE_FLAGS OUTPUT_VAR)
    ...
    elseif(${PROGRAMMER}.communication STREQUAL "serial")
        ...
        if(${PROGRAMMER}.regulation_speed)
            list(APPEND AVRDUDE_ARGS "-b${${PROGRAMMER}.regulation_speed}") # Set baud rate
        endif()
    endif()
...
function(setup_arduino_bootloader_args BOARD_ID TARGET_NAME PORT AVRDUDE_FLAGS OUTPUT_VAR)
    ...
    if(${BOARD_ID}${ARDUINO_CPUMENU}.upload.regulation_speed)
        set(UPLOAD_SPEED ${${BOARD_ID}${ARDUINO_CPUMENU}.upload.regulation_speed})
    endif()
...
#
#        MSG - Message to print_stored_data
#
